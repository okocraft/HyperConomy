...
public class CompositeShopTradeItem extends BasicShopTradeObject implements TradeObject {
	...
	public CompositeShopTradeItem(HyperConomy hc, String playerShop, CompositeTradeItem ho, double stock,
			double buyPrice, double sellPrice, int maxStock, TradeObjectStatus status, boolean useEconomyStock) {
