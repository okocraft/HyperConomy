...
public interface TradeObject extends Comparable<TradeObject>, Serializable {
	...
	/**
	 * @param name
	 * @return True if the name, displayname, or an alias matches the given name,
	 *         false if not.
	 */
	...
	/**
	 * @return The TradeObjectType enum which represents the TradeObject type for
	 *         this TradeObject.
	 */
	...
	/**
	 * @return The total stock for this TradeObject. (Includes stock which resides
	 *         in PlayerShops that are a part of this TradeObject's economy)
	 */
	...
	/**
	 * Adds the specified alias to the TradeObject. The TradeObject can be obtained
	 * using this alias in the future.
	 * 
	 * @param alias
	 */
	...
	/**
	 * Removes the specified alias from the TradeObject. The TradeObject can no
	 * longer be obtained using this alias.
	 * 
	 * @param alias
	 */
	...
	/**
	 * If set to true, the TradeObject will use static pricing. It will use standard
	 * pricing if set to false.
	 * 
	 * @param isstatic
	 */
	...
	/**
	 * If set to true the TradeObject will use initial pricing. It will use standard
	 * pricing if set to false.
	 * 
	 * @param initiation
	 */
	...
	/**
	 * Returns true if the any of this TradeObject's names start with the specified
	 * String part, false if not.
	 * 
	 * @param part
	 * @return
	 */
	...
	/**
	 * Returns true if the any of this TradeObject's names contain the specified
	 * String part, false if not.
	 * 
	 * @param part
	 * @return
	...
	/**
	 * @return Returns the maximum quantity that can be sold. (Prevents pricing
	 *         problems when switching between initial and dynamic pricing.)
	 */
	...
	/**
	 * Changes the TradeObject to dynamic mode if the stock has reached the proper
	 * level.)
	 */
	public void checkInitiationStatus();

	/**
	 * Makes sure the specified price complies with this TradeObject's ceiling and
	 * floor values. If the specified value is greater than the ceiling, it will be
	 * set to the ceiling, and if it it is less than the floor it will be set to the
	 * floor value.
	 * 
	 * @param value
	 * @return
	...
	/**
	 * @param width  of image (if negative width with be based on height, preserving
	 *               aspect ratio)
	 * @param height of image (if negative height will be based on width, preserving
	 *               aspect ratio)
	 * @return An image of this TradeObject. If no image is available the method
	 *         will return null. If both width and height are negative, the image's
	 *         original height and width will be used.
	 */
	public Image getImage(int width, int height);

	/**
	 * @return A list of objects that depend on this object. List will be empty if
	 *         composite items are disabled.
	 */
	...
	/**
	 * Returns an estimated sales tax value for the given sell price. To get an
	 * exact value dynamic tax rates must be applied which depends upon the
	 * HyperPlayer. Use the getSalesTax(value) method in the HyperPlayer object for
	 * an exact sales tax.
	 * 
	 * @param value
	 * @return
	...
	/**
	 * Returns the actual sell price (excluding tax) for this TradeObject and
	 * HyperPlayer. The HyperPlayer is needed in case the item being sold is
	...
	/**
	 * Returns the complete sell price for this TradeObject including sales tax. The
	 * HyperPlayer is needed in case the item being sold is damaged. The player's
	 * inventory will be checked for damaged items.
	 * 
	 * @param amount
	 * @param hp
	 * @return
	...
	/**
	 * Returns a theoretical sale price excluding any damage to the item being sold
	 * etc.
	 * 
	 * @param amount
	 * @return
	...
	/**
	 * Adds the given quantity of this TradeObject to the HyperPlayer. The means by
	 * which the TradeObject is added will depend on the type of TradeObject.
	 * 
	 * @param amount
	 * @param hp
	 */
	...
	/**
	 * Removes the given quantity of this TradeObject from the HyperPlayer. The
	 * means by which the TradeObject is removed will depend on the type of
	 * TradeObject.
	 * 
	 * @param amount
	 * @param hp
	...
	/**
	 * Returns the ItemStack representation of this TradeObject. (Can only be used
	 * with items.)
	 * 
	 * @return
	 */
	...
	/**
	 * Sets this TradeObject's ItemStack representation. (Can only be used with
	 * items.)
	 * 
	 * @param stack
	 */
	...
	/**
	 * Returns the ItemStack representation of this TradeObject and applies the
	 * given quantity. (Can only be used with items.)
	 * 
	 * @param amount
	 * @return
	 */
	...
	/**
	 * @param stack
	 * @return True if this TradeObject represents the given SerializableItemStack,
	 *         false if not.
	 */
	...
	/**
	 * @return A Map of this composite item's components with the TradeObject as the
	 *         key and the recipe ratio as the value. (Can only be used with
	 *         composite items.)
	 */
	...
	/**
	 * Sets this object's component list string. (Can only be used with composite
	 * items.)
	 * 
	 * @param components
	 */
	...
	/**
	 * Makes this composite object a component object. (Doesn't delete the main
	 * tradeobject, only clears the COMPONENTS field.)
	 * 
	 */
	...
	/**
	 * Returns the buy price for this Enchantment TradeObject. (Can only be used
	 * with Enchantments.)
	 * 
	 * @param enchantClass
	 * @return
	...
	/**
	 * Returns the theoretical sell price for this Enchantment TradeObject ignoring
	 * any damage to the item which the enchantment is on. (Can only be used with
	 * Enchantments.)
	 * 
	 * @param enchantClass
	 * @return
	...
	/**
	 * Returns the sell price for this Enchantment TradeObject. This method will
	 * take into account damage to the enchanted item. (Can only be used with
	 * Enchantments.)
	 * 
	 * @param enchantClass
	 * @return
	...
	/**
	 * @return The TradeObject in Enchantment form. (Can only be used with
	 *         Enchantments.)
	 */
	public HEnchantment getEnchantment();

	/**
	 * @return The TradeObject's enchantment level. (Can only be used with
	 *         Enchantments.)
	 */
	public int getEnchantmentLevel();

	/**
	 * @return The TradeObject's Enchantment name. (Can only be used with
	 *         Enchantments.)
	 */
	...
	/**
	 * @return This PlayerShop object's Shop. (Can only be used with PlayerShop
	 *         objects.)
	 */
	public PlayerShop getShopObjectShop();

	/**
	 * @return This PlayerShop object's TradeObject. (Can only be used with
	 *         PlayerShop objects.)
	 */
	public TradeObject getParentTradeObject();

	/**
	 * @return This PlayerShop object's buy price. (Can only be used with PlayerShop
	 *         objects.)
	 */
	public double getShopObjectBuyPrice();

	/**
	 * @return This PlayerShop object's sell price. (Can only be used with
	 *         PlayerShop objects.)
	 */
	public double getShopObjectSellPrice();

	/**
	 * @return This PlayerShop object's maximum stock. (Can only be used with
	 *         PlayerShop objects.)
	 */
	public int getShopObjectMaxStock();

	/**
	 * @return This PlayerShop object's trade status. (Can only be used with
	 *         PlayerShop objects.)
	 */
	public TradeObjectStatus getShopObjectStatus();

	/**
	 * @return Returns true if this playershop object is set to use its economy's
	 *         stock levels.
	 */
	...
	/**
	 * Saves this tradeobject to the database, replacing all current data in the
	 * database with the data in RAM. Does not trigger any events. Should only be
	 * used under special circumstances such as remote GUI updates.
	 */
	public void save();
}
