...
public class ComponentTradeItem extends BasicTradeObject implements TradeObject {
	...
	public ComponentTradeItem(HyperConomy hc, HyperEconomy he, String name, String economy, String displayName,
	...
	public Image getImage(int width, int height) {
		...
		if (sis.getMaterial().equalsIgnoreCase("POTION")) {
			...
			url = hc.getClass().getClassLoader()
					.getResource("Images/" + sis.getMaterial().toLowerCase() + "_" + sis.getData() + ".png");
		}
		try {
			i = ImageIO.read(url);
			if (i != null) {
