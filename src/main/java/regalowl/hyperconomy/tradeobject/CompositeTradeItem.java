...
public class CompositeTradeItem extends ComponentTradeItem implements TradeObject {
	...
	public CompositeTradeItem(HyperConomy hc, HyperEconomy he, String name, String economy, String displayName,
			String aliases, String categories, String type, String compositeData, int objectDataId, String objectData,
			double version) {
		super(hc, he, name, economy, displayName, aliases, categories, type, 0, "", 0, 0, 0, "", 0, 0, 0, 0,
				compositeData, objectDataId, objectData, version);
	...
	// The following methods calculate the HyperObject's values based on the
	// CompositeItem's component items.
	...
	// The setStock method updates the stock for all component items to the correct
	// level.
