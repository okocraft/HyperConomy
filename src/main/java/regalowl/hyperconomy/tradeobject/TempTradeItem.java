...
public class TempTradeItem extends ComponentTradeItem implements TradeObject {
	...
	public TempTradeItem(HyperConomy hc, HyperEconomy he, String name, String economy, String displayName,
	...
	public static TradeObject generate(HyperConomy hc, HItemStack stack) {
		...
		if (dataId == null) {
			...
			return new TempTradeItem(hc, null, name, "default", displayName, "", "", "item", value, "false", startprice,
					0.0, median, "true", startprice, 0.0, 0.0, 0.0, "", nextId, data, 1);
		} else {
			return new TempTradeItem(hc, null, name, "default", displayName, "", "", "item", value, "false", startprice,
					0.0, median, "true", startprice, 0.0, 0.0, 0.0, "", dataId, data, 1);
		}
	}
