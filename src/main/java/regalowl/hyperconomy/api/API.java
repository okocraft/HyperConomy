...
public interface API {
	...
	/**
	 * @param player (name of player)
	 * @return The random hash for the specified player. If the player is not in the
	 *         HyperConomy database it returns ""
	 */
	public String getSalt(String player);

	/**
	 * @param Item entity
	 * @return Returns true if the given Item is being used as an ItemDisplay and
	 *         false if it is not.
	 */
