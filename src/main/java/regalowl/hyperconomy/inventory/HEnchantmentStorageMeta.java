...
public class HEnchantmentStorageMeta extends HItemMeta {
	...
	public HEnchantmentStorageMeta(String displayName, ArrayList<String> lore, ArrayList<HItemFlag> itemFlags,
			boolean unbreakable, int repairCost, ArrayList<HEnchantment> enchantments) {
