...
public class MainPage extends HttpServlet {
	...
	private String buildPage() {
		...
		page += "</script>\n";
		page += "<style>\n";
		page += "* {font-family:" + hcw.getFont() + ";font-size:" + (hcw.getFontSize() * 2) + "px;color:"
				+ hcw.getFontColor() + ";}\n";
		page += "body {background:" + hcw.getBackgroundColor() + ";}\n";
		page += "td {vertical-align:top;text-align:center;padding: 3px;border:1px solid " + hcw.getBorderColor()
				+ ";background:" + hcw.getTableDataColor() + ";}\n";
		...
		if (shops != null && shops.size() > 0) {
			for (Shop s : shops) {
				page += "<TR>\n";
				page += "<TD>\n";
				page += "<a href=\"" + s.getName() + "\" style=\"display:block;text-decoration:none;\">"
						+ s.getDisplayName() + "</a>\n";
				page += "</TD>\n";
				page += "</TR>\n";
			}
